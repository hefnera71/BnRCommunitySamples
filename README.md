...
* **"SHA256"** - hash algorithm  (how to use: see [README.md](AS412CodeSamples/Logical/SHA256/readme.md) ) 
* **"TBSWAstro"** - calculation of sunrise / sunset at a specific date (how to use: see [README.md](AS412CodeSamples/Logical/TBSWAstro/readme.md) ) 
...
*  **"ModuleMonitoring"** - log BR module changes in logger (how to use: see [README.md](AS412CodeSamples/Logical/ModuleMonitoring/readme.md) )
...
*  **"TasmotaWebservice"** - A simple webservice library to communicate with [Tasmota devices](https://tasmota.github.io/docs/) (how to use: see code comments in [sample task](AS412CodeSamples/Logical/TasmotaWebservice/UsageTasmo/Main.st) and [README.md](AS412CodeSamples/Logical/TasmotaWebservice/readme.md) )
...
* "LoggerDataReading" --> **"WebserviceUsingReadEvLog"** - a webservice that uses ReadEvLog library to provide a webbased access for the logger modules (how to use: see [README.md](AS412CodeSamples/Logical/LoggerDataReading/WebserviceUsingReadEvLog/readme.md) )
...
* **"UUIDgen"** - a library that implements a Universally Unique Identifier like defined per RFC (how to use: see [README.md](https://github.com/hefnera71/BnRCommunitySamples/tree/master/AS412CodeSamples/Logical/UUIDGenerator/readme.md) )
* **WsRbacAuthUpload** - a library set that implements a https based authentication and file upload webservice (how to use: see [README.md](https://github.com/hefnera71/BnRCommunitySamples/tree/master/AS412CodeSamples/Logical/WsRbacAuthUpload/readme.md) )
...
* Alexander Hefner  
* Steffen H. (providing the first version of "RWPahoMqtt")
* Andreas W, (providing the first version of "wbuplduuid") 
