...
* **"JsonReader"** - read a JSON string into a structured array (how to use: see [README.txt](https://github.com/hefnera71/BnRCommunitySamples/blob/master/AS412CodeSamples/Logical/JsonReader/UsageTJlb/README.txt) )
